                ...
                endAdornment={
                  <InputAdornment position='end'>
                    <IconButton
                      ...
                      aria-label='Clique para visualizar a senha'
                    >
            ...
            <FormControlLabel
              ...
              label={
                <Fragment>
                  <span>Eu aceito </span>
                  <Link href='/' passHref>
                    <LinkStyled onClick={e => e.preventDefault()}>termos e políticas de privacidade</LinkStyled>
                  </Link>
                </Fragment>
              }
            />
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap', justifyContent: 'center' }}>
              ...
              <Typography variant='body2'>
                <Link passHref href='/pages/login'>
                  <LinkStyled>Clique aqui para Entrar</LinkStyled>
                </Link>
              </Typography>
            </Box>
